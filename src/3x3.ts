class RubiksCube {
  ...
  private performMove(move: string) {
    if (move === "U") {
      // Edge movements
      var tempEdge = this.edgePermutation[0];
      ...
      this.edgePermutation[1] = tempEdge;

      // Corner movements
      var tempCorner = this.cornerPermutation[0];
      ...
      this.cornerPermutation[1] = tempCorner;
    } else if (move === "D") {
      // Edge movements
      var tempEdge = this.edgePermutation[8];
      ...
      this.edgePermutation[9] = tempEdge;

      // Corner movements
      var tempCorner = this.cornerPermutation[4];
      ...
      this.cornerPermutation[5] = tempCorner;
    } else if (move === "R") {
      // Edge movements
      var tempEdge = this.edgePermutation[1];
      ...
      this.edgePermutation[5] = tempEdge;
      ...
      // Edge movements
      var tempEdge = this.edgePermutation[3];
      ...
      this.edgePermutation[7] = tempEdge;
      ...
      this.cornerOrientation[0] = (this.cornerOrientation[0] + 2) % 3;
  ...
  fbEoSovled(): boolean {
    return this.edgeOrientation === this.solvedEdgeOrientation;
  }
